...
class ATR(_BaseDataset):
    ...
    def _set_files(self):
        img_folder = osp.join(self.root, "JPEGImages")
        label_folder = osp.join(self.root, "SegmentationClassAug")
        img_list = os.listdir(img_folder)
        label_list = [osp.join("SegmentationClassAug", img_name.split(".")[0] + ".png") for img_name in img_list]
        img_list = [osp.join("JPEGImages", img_name) for img_name in img_list]
